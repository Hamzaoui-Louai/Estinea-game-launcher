import { C as CredentialsProviderError, s as setCredentialFeature } from "./main-BWUHA6Mk.js";
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
  ...
  if (!roleAssumerWithWebIdentity) {
    const { getDefaultRoleAssumerWithWebIdentity } = await import("./index-SUSAZAi4.js");
