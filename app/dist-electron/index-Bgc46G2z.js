import { C as CredentialsProviderError, s as setCredentialFeature } from "./main-CVza3XXe.js";
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
  ...
  if (!roleAssumerWithWebIdentity) {
    const { getDefaultRoleAssumerWithWebIdentity } = await import("./index-DHQsGuhJ.js");
