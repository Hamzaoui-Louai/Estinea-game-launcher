import { C as CredentialsProviderError, s as setCredentialFeature } from "./main-CP9di1Mu.js";
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
  ...
  if (!roleAssumerWithWebIdentity) {
    const { getDefaultRoleAssumerWithWebIdentity } = await import("./index-BePDILx9.js");
