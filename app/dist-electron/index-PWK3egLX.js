import { C as CredentialsProviderError, s as setCredentialFeature } from "./main-A8bEEj67.js";
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
  ...
  if (!roleAssumerWithWebIdentity) {
    const { getDefaultRoleAssumerWithWebIdentity } = await import("./index-DeqxruPB.js");
