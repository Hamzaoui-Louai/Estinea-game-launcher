import { C as CredentialsProviderError, s as setCredentialFeature } from "./main-DnuuDXPZ.js";
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
  ...
  if (!roleAssumerWithWebIdentity) {
    const { getDefaultRoleAssumerWithWebIdentity } = await import("./index-BeFE3Kkp.js");
