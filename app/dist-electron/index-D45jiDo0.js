import { C as CredentialsProviderError, s as setCredentialFeature } from "./main-N35crAIP.js";
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
  ...
  if (!roleAssumerWithWebIdentity) {
    const { getDefaultRoleAssumerWithWebIdentity } = await import("./index-CNICh6Q3.js");
