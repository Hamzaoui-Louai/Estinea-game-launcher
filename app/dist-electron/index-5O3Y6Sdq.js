import { P as ProviderError, I as IniSectionType, k as CONFIG_PREFIX_SEPARATOR, m as slurpFile, n as getConfigFilepath, o as parseIni, q as getSSOTokenFilepath, h as getProfileName, r as getSSOTokenFromFile, C as CredentialsProviderError, s as setCredentialFeature } from "./main-yBo8e_ut.js";
import "os";
import "path";
import "crypto";
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
  var _a, _b, _c;
  const { SSOOIDCClient } = await import("./index-C2ZBtt6S.js");
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
  const { CreateTokenCommand } = await import("./index-C2ZBtt6S.js");
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, logger }) => {
  ...
  const { SSOClient, GetRoleCredentialsCommand } = await import("./loadSso-Cw15XY0N.js");
