import { C as CredentialsProviderError, s as setCredentialFeature } from "./main-kc0GCZR0.js";
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
  ...
  if (!roleAssumerWithWebIdentity) {
    const { getDefaultRoleAssumerWithWebIdentity } = await import("./index-Cp0ExYP8.js");
